...
![](dis1.png) ![](dis2.png) If you want to extend the project you could mess around with making the plot interactive by using plotly to show information on individual Waffle Houses when you mouse over them.
