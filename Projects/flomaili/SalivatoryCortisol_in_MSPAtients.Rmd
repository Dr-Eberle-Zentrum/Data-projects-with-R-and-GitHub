...
* Divide the patients into MS duration groups with an interval of 6 months and create a bar chart showing the average NO test value with standard deviation for each of these duration groups.(++)
* Divide the patients into age groups with an interval of 15 years and crate a bar chart showing the mean number of diseases for each of these age groups. Keep in mind that MS is also counted as a disease.(++)