...
```{r Saisonale-Temperaturentwicklung}
klimadaten %>%
...
```{r Zusammenhang-Niederschlag-Heisse-Tage}
...
```{r Entwicklung-Extrem-Temperaturtage}
...
```{r Korrelationsmatrix-und-Scatterplot}
klimadaten %>%
         filter(saison == "kalenderjahr") %>%
