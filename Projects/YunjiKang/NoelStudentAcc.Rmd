...
I really failed at this task. The challenge I can't cope with is to translate the names in the variable "geo" into coordinates using the NUTS-3 system. I urgently need help with this. The code for the plot should work in theory as soon as I have the coordinates.
...
The challenge here was the combination of the three data sets and the so-called "reshaping" of the data from "Crime_data_for_Task2.gz". That took me a lot of time. I hope I succeeded.
