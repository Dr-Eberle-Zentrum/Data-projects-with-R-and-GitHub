...
-   BDI timepoints: Assessed at 2, 4, and 6 weeks
...
The dataset consists of sleep monitoring data collected via a wearable device (smartwatch) throughout an extended period. The data spans from February 7, 2024 through September 8, 2025, providing nearly continuous daily sleep recordings across approximately 19 months.

Second dataset contains PANAS (Positive and negative affect schedule) daily mood ratings and BDI (Beck Depression Inventory) scores at multiple postpartum timepoints, but these are available in another files and have to be combined.
...
The second dataset is also in a CSV file with columns: participant date PANAS_positive PANAS_negative. Thirds contains BDI scores with columns: participant date BDI_score.
