...
-   I would assume that there is no difference between Populus and Indet. It's interesting to see if there is a cluster by a specific radius size or if they are randomly distributed
...
-   I would except that with bigger radius the standard deviation increase
