...
- Now, we will focus on the GO terms to get on rough idea what biological processes are upregulated and downregulated. Filter the up- and downregulated GO terms to include only those whose description contains keywords such as "angiogenesis", "immune response", or "cytokine".
