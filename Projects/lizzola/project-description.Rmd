...
- Now, we will focus on the GO terms to get on rough idea what biological processes, but not single genes are upregulated. Filter the upregulated GO terms to include only those whose description contains keywords such as "angiogenesis", "immune response", "immunity", "cytokine", "vasculature", "wound", "inflammatory response", "chemokine", "lymphatic", "lymphocyte", "macrophage", "monocyte".
