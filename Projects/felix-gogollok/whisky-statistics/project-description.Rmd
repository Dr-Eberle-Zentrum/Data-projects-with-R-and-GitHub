...
Since my last attempt at updating the project ended in something that still does not work, I will try it now with a statistic project related to whisky. Note that I removed the “Inventarnummer”, “Einkaufspreis”, “letzte Expertenschätzung”, “Stand der letzten Expertenschätzung”, “letzter Auktionswert” and “Stand des letzten Auktionswertes” columns from the data set. This dataset originates as part of the inventory database from my family’s extensive spirits collection. The data set to be used in this project is available in the project folder as “Whisky.csv”.
...
The data used in this project was manually entered into a relational database system. It’s origin is private by nature.