...
---
## Data
The Auto dataset is a collection of various automobile models and their characteristics. It contains quantitative and qualitative variables describing different aspects of cars such as fuel efficiency, engine size, weight, acceleration, and more. The dataset is useful for exploring regression modeling, correlation analysis, and data visualization.
