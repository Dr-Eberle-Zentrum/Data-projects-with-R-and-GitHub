...
```{r  data_importation_manipulation_and_calculation, result = "hide"}
...
#corona_eu <- read_xlsx("https://opendata.ecdc.europa.eu/covid19/nationalcasedeath_eueea_daily_ei/xlsx/data.xlsx") %>%
corona_eu <- read_xlsx("data.xlsx") %>%
