...
The idea of this project is to recreate the "Bye Bye Birdie" plot below as close as possible using the data from Burns et al. (2021) which is linked above. I am particularly interested in which of the bird species increased in population and which decreased in population. 
