...
------------------------------------------------------------------------
    ...
    freda<-read_csv("FReDA_panel_4waves_long_labeled.csv.zip")
...
![](Minseo_files/figure-markdown_strict/heatmap-1.png)
...
![](Minseo_files/figure-markdown_strict/regional_histograms-1.png)
