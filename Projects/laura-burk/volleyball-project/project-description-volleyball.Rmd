...
(In the VBL, transfers are possible from the end of *Zwischenrunde*, thus before all parts of the season have ended, see [below](#games). That is why the same player can have two different teams within one season.)
