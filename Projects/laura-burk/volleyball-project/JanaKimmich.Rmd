...
Unfortunately the circular bar plots do not contain much information, since I could not resolve the issue of assigning the teams to the topscorer files (and how to group the players).
