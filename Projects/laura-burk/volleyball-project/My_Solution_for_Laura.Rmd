...
**Finally got the Result and Stadium stuff ready, lets go for the next.**
...
For a finally fix, as mentioned before, we should fix the  mistakes in names first by using our `get_unique_values` function

Anyway let's go for mutating the rest of requested variables

***

```{r mutate_atck_topscore_var, echo=TRUE}
