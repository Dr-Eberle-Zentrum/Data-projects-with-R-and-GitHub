...
To download the dataset directly from the website you would have to create an account. If you don't want to do that, I've downloaded the dataset myself and stored it in my directory on GitHub. The directory can be found [here](kaggle_dataset.csv)

Still feel free to check out the dataset on Kaggle. It is located [here](https://www.kaggle.com/datasets/valakhorasani/mobile-device-usage-and-user-behavior-dataset). You can find further information about the dataset under the section **Data Card**.
...
# Visualization Goals
Try to visualize the data in such a way that it will more or less lead to such a graph: ![](graph_idea.jpg).
...
- add pictures of the operating system to each device model
