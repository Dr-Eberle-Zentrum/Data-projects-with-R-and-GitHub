...
```{r raw_data}
rawdata <- readr::read_csv("/Users/huangziyi/Downloads/ECU_2020_SLO-COVIDRS_v01_M_CSV/project data.csv")
```
...
## project idea
To modify the plot on the 13. page of the datei "wd_covidpaper_ecuador_withtablesfigures.pdf" on the webseit, I would like to use points instead of bars, whose colors demonstrate the access of the students to remote learning technologies and forms (like square, triangle, circle …) show the grades of the students. If possible, small images (like TV, computer ect.) at x-axis and labels beside the points will be added.  
