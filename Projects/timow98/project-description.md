...
example mapview, sf and ggplot2.
[<span style="color:blue">This</span>](https://stackoverflow.com/questions/66827313/plotting-utm-coordinates)
might be a good point to start - in this case you will need to use
mapview and sf. Depending on your way to do it you might need additional
information:  
