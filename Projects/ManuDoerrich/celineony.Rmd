...
# read data 
# readxl package
url <- "https://naehrwertdaten.ch/wp-content/uploads/2023/08/Swiss_food_composition_database.xlsx"
GET(url, write_disk(tf <- tempfile(fileext = ".xlsx")))
data <- read_excel(tf, col_names = T, na = "NA", skip = 2)
```
...
Day 1:
 ...
 -Broccoli, steamed: 100g
  - "Broccoli, steamed (without addition of salt)" 
 -Olive oil: 10g
 -Almonds: 30g
     - "Almond"    
 -Low-fat Yogurt: 150g
...
Day 2:
 ...
 -Sunflower Oil: 10g
 -Walnuts: 20g
 -Soya drink, plain, with calcium and vitamin fortified: 200ml
