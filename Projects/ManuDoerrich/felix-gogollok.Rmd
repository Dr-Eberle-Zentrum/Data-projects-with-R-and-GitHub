...
nutrient_selection <- nutrient_selection %>%
  mutate(
    ...
    Pantothenic_acid_coverage = `Pantothenic acid (mg)` / daily_requirements["Pantothenic_acid_mg"],
...
pie_data <- tibble(
  Nutrient = c(
    ...
    "Niacin", "Folate", "Pantothenic acid", "Vitamin C", "Vitamin D", "Vitamin E"
  ),
  Coverage = c(
...
pie_data <- pie_data %>%
  mutate(
    Category = case_when(
      ...
      Nutrient %in% c("Vitamin A", "Vitamin B1", "Vitamin B2", "Vitamin B6", "Vitamin B12", "Niacin", "Folate", "Pantothenic acid", "Vitamin C", "Vitamin D", "Vitamin E") ~ "Vitamins",
      TRUE ~ "Minerals"
    )
  )
...
print("Pie chart successfully created and saved as 'daily_nutrient_saturation_pie_chart.png'")
