...
# **Topic of the Project [[🔗](#Topic-of-the-Project)]{.invisible-link}** {#topic-of-the-project}
...
# **Dataset** `r emo::ji("bar_chart")` [[`r emo::ji("link")`](#Dataset)]{.invisible-link}
...
-   The [folder **tables**](./Datasets/tables): contains **3 .csv tables** `r emo::ji("bar_chart")`, these tables represent **the data** what should be done for **each component/ work part**. These tables can be **mergeed to one** by the column `#`
...
## **Codebook Structure** `r emo::ji("warning")` [[🔗](#Codebook-Structure)]{.invisible-link}
...
### **Section:** `r emo::ji("arrow_right")` [[🔗](#Section:)]{.invisible-link}
...
### **TextBaustein:** `r emo::ji("abc")` [[🔗](#TextBaustein:)]{.invisible-link}
...
### **Table_ID:** `r emo::ji("book")` [[🔗](#Table_ID:)]{.invisible-link}
...
-   It can also contain values in square brackets that refer to corresponding columns in **Tables 1-3**. The values in the columns can be seen as values and/or conditions. These values can consist of strings, images, or booleans.
    ...
    → **Note:** If the reference to a column value/condition is `false` or contains `NA`s or `0`, the corresponding image/string in the respective **Section** from the **Codebook** need **not be included**.
...
### **String:** `r emo::ji("curl")` [[🔗](#String:)]{.invisible-link}
...
### **Image:** `r emo::ji("photo")` [[🔗](#Image:)]{.invisible-link}
...
## **The Table's:** `r emo::ji("chart_with_upwards_trend")` [[🔗](#The-Table's)]{.invisible-link}
...
# **The Final SOP Layout** `r emo::ji("warning")` [[🔗](#The-SOP-Layout)]{.invisible-link}
...
## **The Table-layout** `r emo::ji("bar_chart")` [[🔗](#The-Table-layout)]{.invisible-link}

------------------------------------------------------------------------

### **Layout: Table Sequence** [[🔗](#Layout:-Table-Sequence)]{.invisible-link}
...
### **Layout: Table format** [[🔗](#Layout:-Table-format)]{.invisible-link}
