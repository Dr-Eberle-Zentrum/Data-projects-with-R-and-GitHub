...
#### Visualization of "Number of Words spoken in each Volume"
...
#### Visualization of Top 9 Characters with the most speaking time

```{r top 9 chart all three books}
...
#### 2.2.2. Visualizaion of Total Speaking Time by Character for each individual book

```{r top_9, fig.width=9, fig.height=18}
...
Solve three tasks related to Frodo's speaking time, and visualize three charts into one scene.

#### 2.3.1. Speaking Time of Frodo across all 3 books

```{r Frodo across all 3 books}
...
```{r Frodo number of chapter he speaks}
...
```{r Frodo percentage of each chapter}
...
#### 2.3.4. All three charts relate to Frodo as a Speaker
