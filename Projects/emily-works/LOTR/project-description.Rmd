...
Once the data is imported and merged, we can begin analyzing the distribution of speakers time.

### 2.1. Speakers Time by Volume
The first step is to calculate the total number of words spoken in each of the three books. For that, create a new table that summarizes the total number of words spoken in each book.
...
Please visualize the distribution of the total number of words using a pie chart, similar to this:
...
- How is the distribution of speakers time among the characters (in %)?
- 
