...
```{r Realm_name_change,echo=FALSE}
...
```{r table_total_words, echo=FALSE}
...
```{r table_each_character, echo=FALSE }
...
```{r top9_chart_character, fig.width=9, fig.height=18, echo=FALSE}
...
```{r Frodo_percentage_each_chapter,echo=FALSE}
...
```{r final_plot, fig.width=15, fig.height=10}
