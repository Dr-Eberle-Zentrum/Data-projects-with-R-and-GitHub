...
: Realm “Lothelórien” was written as “Lothl-rien”, so changed the name
for it.

### 1.2. Cleaning up NA

: Found several NA data, and changed them into “Unknown” so that the
other information of the column still remains.
