...
top5 <- top_actors %>%
  ...
  slice_max(score, n = 5)
```
Funnily, the guy from the ZDF heute-Show representing "Ulrich von Heesen" has the highest rating if restricted to >10 appearences.
...
ggplot(top_actors, aes(x = appearances, y = avg_rating)) +
  ...
  theme_minimal()
```
The upper cluster are all "Dexter" actors.
