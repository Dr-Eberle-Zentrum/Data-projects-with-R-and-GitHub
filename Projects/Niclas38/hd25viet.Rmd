...
```{r Plot of votes and rating, fig.width=10, fig.height=8, warning=FALSE}
...
top5 <- top_actors %>%
  ...
  slice_max(score, n = 5)
```
[Anna Gunn](https://en.wikipedia.org/wiki/Anna_Gunn) as top actoress with more then 5 appearances is known for the role of Skyler White in Breaking Bad.
