...
![Plot Sales vs Type](Plots_baptistesolard/1_Sales_Type.png){#id .class width=100%}
...
![Plot Revenue vs Type](Plots_baptistesolard/2_Revenue_Type.png){#id .class width=100%}
...
![Plot Sales vs Type by Size](Plots_baptistesolard/3_Sales_Type_Size.png){#id .class width=100%}
...
![Sales vs Type by Location](Plots_baptistesolard/4_Sales_Type_Location.png){#id .class width=100%}
...
![Plot Revenue vs Type by Size](Plots_baptistesolard/5_Revenue_Type_Size.png){#id .class width=100%}
...
![Plot Revenue vs Type by Location](Plots_baptistesolard/6_Revenue_Type_Location.png){#id .class width=100%}
