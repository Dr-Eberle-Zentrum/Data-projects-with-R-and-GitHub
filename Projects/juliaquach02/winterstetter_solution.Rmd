...
```{r, echo=FALSE}
knitr::kable(all_cells_mean |> subset(group == "Treatment Group") |> arrange(total_alive) |> head())
```
...
You can see that only a small amount of cells did completely die during the time of observation.
