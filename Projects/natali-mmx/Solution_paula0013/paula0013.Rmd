...
p1 <- data %>%
  ...
  geom_smooth(method = "lm", se = FALSE, aes(color = species))+
      facet_wrap(
            ...
            "precipitation" = "Relationship between crop and precipitation [mm]",
            "air_temperature" = "Relationship between crop and air temperature [°C]",
            "frost_days" = "Relationship between crop and frost days [days]"
      ))) + 
    labs(
...
p2 <-data %>%
  ...
  geom_smooth(method = "loess", se = FALSE, color = "black")+
      ...
      'grain maize' = "crop yield of grain maize over the time",
      'spring barley' = "crop yield of spring barley over the time",
      'winter wheat' = "crop yield of winter wheat over the time"
    )))+ 
    labs(
      title = "Crop yields over the time", 
      x = 'Year', 
      y = 'Yield (t/ha)', 
