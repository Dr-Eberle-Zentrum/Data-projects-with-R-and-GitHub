...
Answer: Only `r mean(freda_2$sat3<=4, na.rm=TRUE)*100` of the respondents are unsatisfied or very unsatisfied with their relationship, while `mean(freda_2$sat3>=9, na.rm=TRUE)*100` answered that they are very satisfied with their relationship.
...
```{r nkids&reldur_control_variables}
