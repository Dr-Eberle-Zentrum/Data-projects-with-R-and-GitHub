...
2.Participants without age information were excluded in the data analysis. NAin other columns counts as numeric 0 while analyzing.
...
6.label names should be following: X-axis Age✖️Sex Group Left-Y-axisProportion of participants Right-Y-axisHISB Rate plot-name Electronic Device Usage and HISB Rate by Age-Sex Group.
