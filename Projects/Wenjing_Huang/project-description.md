...
concept, most studies confirmed that orgin of country, place of
residence,gender..many factors had an impact on online HISB.Shifting
focus to less developed countries, questions arise: How do the youth
engage with digital platforms, and what is the real gap from age-groups?
Do they use which type of social media to search health information? To
address this, we analyze a dataset from Vanuatu, a South Pacific island
nation.
...
You need to import and get a short overview of data. You can find data
in the following
link(<https://zenodo.org/records/17154763/files/2024-12-09_FALAH_Vanuatu_socialMediaUse_Zenodo_anonymized.csv?download=1>).
...
-   Questionaire:
    ...
    -   2.When you are on your mobile phone, what type of actions do you
        perform most often? single choice: ticked or not (“Checked” or
        “Unchecked”)
...
You need to tidy data. And final table should look like the preview that
showed on the
webseits\[<https://zenodo.org/records/17154763?preview_file=undefined>\]
...
1.Is there a huge difference between female and male/diffrent
age-groups, when it comes to HISB? 2.Is there a strong or weak relation
between general perform behaviours on electricities and HISB?
