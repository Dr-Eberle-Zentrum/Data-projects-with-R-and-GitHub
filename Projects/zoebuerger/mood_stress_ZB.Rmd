...
### Our goal: 
The goal is to obtain boxplots with violins (see picture below) for feelings of **stress**, **positive mood**, **negative mood** and **anger** for the four conditions (pre_placebo, post_placebo, pre_MAST, post_MAST) and the three groups (see excel plot below for a barplot representation of this).
...
Think about what other plots or visualisation tools you could use to look at the data you tidied, one example might be a barplot with individual data points! 
