...
Which conclusions/hypotyhesis can we draw from the resulting graph? Do they match some of the results of the study (found in "Presentation 1")?

Best of luck on your implementation!
 
![Example spider-web diagram](Example spider-web diagram.png =200x)
