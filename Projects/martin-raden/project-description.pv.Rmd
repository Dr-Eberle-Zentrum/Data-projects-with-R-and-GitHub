...
Hier ein Beispiel der Produktionsübersicht einer VARTA Anlage.
...
Die Daten der Photovoltaikanlage inklusive Speicher wurden von der Herstellerseite monatsweise exportiert und stehen im `./PV/` Unterordner dieses Projektverzeichnisses jeweils als ZIP Datei zur Verfügung.
Jede ZIP-Datei enthält eine CSV-Datei mit den Daten des jeweiligen Monats, welche wie folgt strukturiert sind:
