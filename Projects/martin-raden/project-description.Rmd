...
![](https://ourworldindata.org/uploads/2022/05/Wildlife-comeback-in-Europe-1.png){ width=50% }
...
In the end, this is a "boring" project, since it solely focuses on visualization details...
