...
The color scheme does not matter and can be chosen to your own liking. Furthermore, the chord diagram here is just an example, as the data given here will not result in the same diagram. Also the looks of the chord diagrams produced by R, might differ quite a bit from the example above.
