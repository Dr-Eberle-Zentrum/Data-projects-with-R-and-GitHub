...
fossil_primary_source <- c("Erdgas", "Steinkohle", "Braunkohle", "Erdgas, Steinkohle", "Gichtgas", "Konvertergas", "Uran", "Steinkohle, Erdgas", "HEL", "HS", "HEL, Crack\u00F6l", "Crack\u00F6l", "Erdgas, Raffineriegas", "Braunkohle, Erdgas", "Erdgas, HEL", "Raffineriegas", "Biomasse, Erdgas", "Erdgas, Biomasse", "\u00D6lrückstand", "Steinkohle, HEL, Abfall", "Erdgas, HS, Cracker\u00F6l", "Cracker\u00F6l")
...
```
As we can see, the production of renewable energies are centralize in the east of the country. The no data cases are states where the production is 100% derivative from fossil primary sources. 