...
p1 <- ggplot(sleepy, aes(x=x, y=y, color = PS03_01)) +
...
#Begin building plot, color = PS gives the groups
p2 <- ggplot(sleepy, aes(x=x, y=y, color = PS03_01)) +
...
#Begin building plot, color = PS gives the groups
p3 <- ggplot(sleepy, aes(x=x, y=y, color = PS03_01)) +
...
resids <- unnest(sleepy, resids)

 
residuals <- ggplot(data = resids, aes(x, resid)) +
  geom_line(aes(group = PS03_01), alpha = 1 / 3) + 
  geom_smooth(se = FALSE) +
  ggtitle("Residuals")

ggsave(plot = residuals, "Residuals.jpg")
```
...
r2 <- ggplot(data = glance, aes(PS03_01, r.squared)) + 
  geom_jitter(width = 0.5) +
  ggtitle("R Squared")

ggsave(plot = r2, "R2.jpg")
```
