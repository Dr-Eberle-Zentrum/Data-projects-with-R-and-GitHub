...
So right now the data wrangling is still very messy. I was having problems filtering for multiple criteria at the same time, so I will try to fix this part in the future!

Also some of the plotting is still very wonky, so I will try to fix that as well!
```{r results='hide'}
