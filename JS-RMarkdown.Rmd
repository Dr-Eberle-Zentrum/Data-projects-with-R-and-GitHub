...
The idea of this project is to recreate the "Bye Bye Birdie" plot as close as possible using the data from Burns et al. (2021) which is linked above.
I am not sure if this is even possible but I really liked the chart.
